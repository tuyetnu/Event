                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">       
                            <li>
                            <s:a href="GetProfile.action"><i class="fa fa-dashboard fa-fw"></i> Dashboard</s:a>
                            </li>
                            <li>
                            <s:a href="ListOffer.action"><i class="fa fa-table fa-fw"></i> List offer event</s:a>
                            </li>
                            <li>
                            <s:a href="/Event/post.jsp"><i class="fa fa-newspaper-o fa-fw"></i> Offer Event</s:a>
                        </li>   
                        <li>
